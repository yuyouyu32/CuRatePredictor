...
param_grid = {
    ...
    'XGBRegressor': {'n_estimators': [10, 50, 100, 200, 500], 'learning_rate': [0.001, 0.01, 0.1, 1, 2], 'max_depth': [3, 5, 10, 20, 50, 100, 200]},
    ...
    # 'n_nodes': [128, 256], 
    # 'lam': [1, 2],
    # 'w_random_vec_range': [[-10, 10]],
    # 'b_random_vec_range': [[0, 10]],
    # 'n_layer': [16, 32, 64],
    # 'random_seed': [random.randint(0, 1000) for _ in range(32)],
    # 'same_feature': [True],
